...
DROP FUNCTION oracle_materialize(name, name);
...
DROP FUNCTION oracle_migrate_tables(name, name, name[]);
...
DROP FUNCTION quote_xml(text);

DROP FUNCTION oracle_export(text, name, name[]);
